...
import boss_money_report
import boss_money_month_report
import account_active_report
import account_info_report
import account_new_report
import account_new_report_v2
reload(sys)
...
spark = SparkSession.builder.master("spark://master:7077").appName("videoes_related_reports").enableHiveSupport().getOrCreate()
...
if  __name__ == "__main__":
    """  报表入口 """
    import time
    #boss_money_report.main()
    time.sleep(3)
    #boss_money_month_report.main()
    time.sleep(3)
    #account_info_report.main()
    time.sleep(3)
    #account_active_report.main()
    time.sleep(3)
    account_new_report.main()
    time.sleep(3)
    account_new_report_v2.main()
    #stop!!
    spark.stop()
