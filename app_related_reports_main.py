...
import app_game_open_report
import app_download_report
import app_install_report
reload(sys)
...
if  __name__ == "__main__":
    ...
    #应用开启
    app_game_open_report.main()
    sleep(5)
    
    #应用下载
    app_download_report.main()
    sleep(5)

    #应用安装
    app_install_report.main()
