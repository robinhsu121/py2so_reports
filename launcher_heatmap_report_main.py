...
#spark.addPyFile('/home/hadoop/build/launcher_heatmap_report.so')
#spark.sparkContext
spark.sparkContext.addFile('/home/hadoop/build_main/launcher_heatmap_report.so') ## works!!
#spark.sparkContext.addFile('/home/hadoop/build.zip') ##does not work!!
