...
spark = SparkSession.builder.master("spark://master:7077").appName("user_reports").enableHiveSupport().getOrCreate()
...
spark.sparkContext.addFile('/home/hadoop/build_main/user_reports.so')
