...
import wechat_publicAccount_report
reload(sys)
...
spark = SparkSession.builder.master("spark://master:7077").appName("public_account_report").enableHiveSupport().getOrCreate()
...
if  __name__ == "__main__":
    """  报表入口 """
    wechat_publicAccount_report.main()
    #stop!!
    spark.stop()
